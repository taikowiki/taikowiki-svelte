...
export namespace Doc {
    export declare namespace Client {
        namespace markdownCommands {
            function insertImage(option: Doc.Toast.ImagePluginFunctionOption, state: any, dispatch: any, view: any): boolean;
            function insertAnnotation(option: Doc.Toast.AnnotPluginFunctionOption, state: any, dispatch: any, view: any): boolean;
            function insertWikiLink(option: Doc.Toast.WikiLinkPluginFunctionOption, state: any, dispatch: any, view: any): boolean;
            function insertYoutube(option: Doc.Toast.WikiYoutubePluginFunctionOption, state: any, dispatch: any, view: any): boolean;
            function insertColoredText(option: Doc.Toast.ColoredTextFunctionOption, state: any, dispatch: any, view: any): boolean;
            function insertBgColoredText(option: Doc.Toast.ColoredTextFunctionOption, state: any, dispatch: any, view: any): boolean;
        }
        const request: {
            uploadNew: ({ docData }: {
                docData: Doc.Data.DocData;
            }) => Promise<RResponse<any>>;
            update: ({ id, docData }: {
                id: number;
                docData: Doc.Data.DocData;
            }) => Promise<RResponse<any>>;
        ...
        const adminRequest: {
            delete: (id: number) => Promise<RResponse<unknown>>;
            restore: (id: number) => Promise<RResponse<unknown>>;
            changeEditableGrade: (id: number, grade: number) => Promise<RResponse<void>>;
            hardDelete: (id: number) => Promise<RResponse<unknown>>
        }
        const element: {
            defineWikiElements: () => void;
            isDefined: () => boolean;
            WikiFrameViewElement: typeof wikiElement.WikiFrameViewElement;
            WikiAnnotationElement: typeof wikiElement.WikiAnnotationElement;
            WikiLink: typeof wikiElement.WikiLink;
            WikiYoutube: typeof wikiElement.WikiYoutube;
            WikiRoot: typeof wikiElement.WikiRoot;
            WikiFloat: typeof wikiElement.WikiFloat;
        }
    }
    export declare namespace Server {
        const DBController: typeof docDBController;
        const setWikiLinkAvailable: typeof prepare.setWikiLinkAvailable;
        const prepareParagraphs: typeof prepare.prepareParagraphs;
    }
}
